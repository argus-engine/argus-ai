...
"""Supply-chain evaluation harness and model card.

The harness reports point-prediction accuracy, calibration, coverage, and
subgroup performance as committed in `docs/responsible_ai.md`. A model card
