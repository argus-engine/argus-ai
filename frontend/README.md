...
Streamlit reviewer dashboard. The HITL surface — see
[`docs/architecture.md`](../docs/architecture.md) for where this fits.

**Phase 1 status:** placeholder. A minimal app showing the FastAPI service's
